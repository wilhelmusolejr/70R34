        ...
        <form className="npm-body" onSubmit={handleSubmit}>
          ...
          {activeTab === 1 && (
            <div className="npm-grid">
              ...
              <Field label="Facebook Password" error={errors.facebookPassword}>
                <input
                  className="npm-input"
                  value={form.facebookPassword}
                  onChange={(e) => setField("facebookPassword", e.target.value)}
                />
              </Field>
              <Field label="Proxy">
                <input
                  ...
                  <Field label="College Graduated">
                    <label className="current-toggle">
                      <input
                        ...
                        onChange={(e) =>
                          setEducation("college", "graduated", e.target.checked)
                        }
                      />
                      Graduated
                    </label>
            ...
            <div className="npm-grid">
              <Field label="Relationship Status">
                <select
                  ...
                  onChange={(e) =>
                    setNested("personal", "relationshipStatus", e.target.value)
                  }
                >
              ...
              <Field label="Other Names">
                <input
                  ...
                  onChange={(e) => setField("otherNamesInput", e.target.value)}
                />
              </Field>
              <Field label="Bio">
                <textarea
